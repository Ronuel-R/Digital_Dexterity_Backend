    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approved_by', models.ImageField(blank=True, null=True, upload_to=digital_dex_admin_web.models.tax_form_model.upload_signature_approval_location)),
                ...
                ('initial_assessment', models.ManyToManyField(blank=True, null=True, to='digital_dex_admin_web.initialassessment')),
            ],
            options={
